...
final productDataSourceProvider = Provider<RestApiProductDataSource>(
  (ref) => RestApiProductDataSource(ref.watch(authenticatedDioProvider)),
);
...
final productLookupDataSourceProvider =
    Provider<RestApiProductLookupDataSource>(
      (ref) =>
          RestApiProductLookupDataSource(ref.watch(authenticatedDioProvider)),
    );

final productLookupRepositoryProvider = Provider<ProductLookupRepository>(
  (ref) =>
      ProductLookupRepositoryImpl(ref.watch(productLookupDataSourceProvider)),
);
